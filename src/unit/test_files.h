...
int test_ordered_index_skiplist_insert_multiple_ordered(int argc, char **argv, int flags);
...
int test_ordered_index_skiplist_seek_inf_reverse_iteration(int argc, char **argv, int flags);
int test_ordered_index_skiplist_seek_inf_forward_iteration(int argc, char **argv, int flags);
int test_ordered_index_fbtree_create_free(int argc, char **argv, int flags);
int test_ordered_index_fbtree_insert_single(int argc, char **argv, int flags);
int test_ordered_index_fbtree_insert_multiple_ordered(int argc, char **argv, int flags);
int test_ordered_index_fbtree_duplicate_scores(int argc, char **argv, int flags);
int test_ordered_index_fbtree_rank_operations(int argc, char **argv, int flags);
int test_ordered_index_fbtree_delete(int argc, char **argv, int flags);
int test_ordered_index_fbtree_update_score(int argc, char **argv, int flags);
int test_ordered_index_fbtree_edge_cases(int argc, char **argv, int flags);
int test_ordered_index_fbtree_delete_edge_cases(int argc, char **argv, int flags);
int test_ordered_index_fbtree_rank_edge_cases(int argc, char **argv, int flags);
int test_ordered_index_fbtree_duplicate_insert(int argc, char **argv, int flags);
int test_ordered_index_fbtree_update_score_edge_cases(int argc, char **argv, int flags);
int test_ordered_index_fbtree_traversal_edge_cases(int argc, char **argv, int flags);
int test_ordered_index_fbtree_mixed_operations_rank_integrity(int argc, char **argv, int flags);
int test_ordered_index_fbtree_backward_traversal_after_deletions(int argc, char **argv, int flags);
int test_ordered_index_fbtree_lexicographic_edge_cases(int argc, char **argv, int flags);
int test_ordered_index_fbtree_special_double_values(int argc, char **argv, int flags);
int test_ordered_index_fbtree_seek_to_rank(int argc, char **argv, int flags);
int test_ordered_index_fbtree_reverse_iteration(int argc, char **argv, int flags);
...
unitTest __test_fbtree_feature_search_c[] = {{"test_feature_search_expected_values", test_feature_search_expected_values}, {"test_feature_search_empty", test_feature_search_empty}, {"test_feature_search_single_match", test_feature_search_single_match}, {"test_feature_search_single_less", test_feature_search_single_less}, {"test_feature_search_single_greater", test_feature_search_single_greater}, {"test_feature_search_two_elements", test_feature_search_two_elements}, {"test_feature_search_three_elements", test_feature_search_three_elements}, {"test_feature_search_before_all", test_feature_search_before_all}, {"test_feature_search_after_all", test_feature_search_after_all}, {"test_feature_search_not_found", test_feature_search_not_found}, {"test_feature_search_duplicates", test_feature_search_duplicates}, {"test_feature_search_all_same", test_feature_search_all_same}, {"test_feature_search_multibyte", test_feature_search_multibyte}, {"test_feature_search_multibyte_tiebreak", test_feature_search_multibyte_tiebreak}, {"test_feature_search_all_bytes_matter", test_feature_search_all_bytes_matter}, {"test_feature_search_deciding_byte", test_feature_search_deciding_byte}, {"test_feature_search_high_values", test_feature_search_high_values}, {"test_feature_search_boundary_values", test_feature_search_boundary_values}, {"test_feature_search_cross_chunk_boundary", test_feature_search_cross_chunk_boundary}, {"test_feature_search_chunk_boundaries", test_feature_search_chunk_boundaries}, {"test_feature_search_last_in_chunk", test_feature_search_last_in_chunk}, {"test_feature_search_first_in_chunk", test_feature_search_first_in_chunk}, {"test_feature_search_no_false_positives", test_feature_search_no_false_positives}, {"test_feature_search_duplicates_cross_chunk", test_feature_search_duplicates_cross_chunk}, {"test_feature_search_full_row", test_feature_search_full_row}, {"test_feature_search_typical_node_size", test_feature_search_typical_node_size}, {NULL, NULL}};
unitTest __test_fbtree_ordered_index_c[] = {{"test_fbtree_create_and_free", test_fbtree_create_and_free}, {"test_fbtree_insert_and_lookup", test_fbtree_insert_and_lookup}, {"test_fbtree_insert_multiple", test_fbtree_insert_multiple}, {"test_fbtree_lookup_empty_tree", test_fbtree_lookup_empty_tree}, {"test_fbtree_length_increments", test_fbtree_length_increments}, {"test_fbtree_iterator_small", test_fbtree_iterator_small}, {"test_fbtree_iterator_full_leaf", test_fbtree_iterator_full_leaf}, {"test_fbtree_iterator_reverse_insert", test_fbtree_iterator_reverse_insert}, {"test_fbtree_iterator_empty", test_fbtree_iterator_empty}, {"test_fbtree_iterator_reset_invalidates", test_fbtree_iterator_reset_invalidates}, {"test_fbtree_duplicate_insert", test_fbtree_duplicate_insert}, {"test_fbtree_empty_string", test_fbtree_empty_string}, {"test_fbtree_multilevel_reverse_insert", test_fbtree_multilevel_reverse_insert}, {"test_fbtree_prefix_ordering", test_fbtree_prefix_ordering}, {"test_fbtree_long_strings", test_fbtree_long_strings}, {"test_fbtree_same_length_ordering", test_fbtree_same_length_ordering}, {"test_fbtree_common_prefix_ordering", test_fbtree_common_prefix_ordering}, {"test_fbtree_insert_batches_sorted", test_fbtree_insert_batches_sorted}, {"test_fbtree_insert_at_boundaries", test_fbtree_insert_at_boundaries}, {"test_fbtree_prev_small", test_fbtree_prev_small}, {"test_fbtree_prev_full_leaf", test_fbtree_prev_full_leaf}, {"test_fbtree_prev_empty", test_fbtree_prev_empty}, {"test_fbtree_prev_next_mixed", test_fbtree_prev_next_mixed}, {"test_fbtree_prev_single", test_fbtree_prev_single}, {"test_fbtree_iterator_exhausted_stays_invalid", test_fbtree_iterator_exhausted_stays_invalid}, {"test_fbtree_multilevel_lookup", test_fbtree_multilevel_lookup}, {"test_fbtree_multilevel_forward_iteration", test_fbtree_multilevel_forward_iteration}, {"test_fbtree_multilevel_backward_iteration", test_fbtree_multilevel_backward_iteration}, {"test_fbtree_multilevel_mixed_iteration", test_fbtree_multilevel_mixed_iteration}, {"test_fbtree_multilevel_cross_leaf_iteration", test_fbtree_multilevel_cross_leaf_iteration}, {"test_fbtree_inner_split_sequential", test_fbtree_inner_split_sequential}, {"test_fbtree_inner_split_reverse", test_fbtree_inner_split_reverse}, {"test_fbtree_inner_split_shuffled", test_fbtree_inner_split_shuffled}, {"test_fbtree_deep_tree_4_levels", test_fbtree_deep_tree_4_levels}, {"test_fbtree_deep_tree_mixed_insert_patterns", test_fbtree_deep_tree_mixed_insert_patterns}, {"test_fbtree_varied_string_patterns", test_fbtree_varied_string_patterns}, {"test_fbtree_split_at_exact_boundary", test_fbtree_split_at_exact_boundary}, {"test_fbtree_alternating_min_max_insert", test_fbtree_alternating_min_max_insert}, {"test_fbtree_sequential_middle_insert", test_fbtree_sequential_middle_insert}, {"test_fbtree_delete_single_item", test_fbtree_delete_single_item}, {"test_fbtree_delete_nonexistent", test_fbtree_delete_nonexistent}, {"test_fbtree_delete_from_empty", test_fbtree_delete_from_empty}, {"test_fbtree_delete_all_items", test_fbtree_delete_all_items}, {"test_fbtree_delete_middle_item", test_fbtree_delete_middle_item}, {"test_fbtree_delete_max_updates_anchor", test_fbtree_delete_max_updates_anchor}, {"test_fbtree_delete_all_multilevel", test_fbtree_delete_all_multilevel}, {"test_fbtree_delete_root_collapse", test_fbtree_delete_root_collapse}, {"test_fbtree_delete_leftmost_leaf_updates_cache", test_fbtree_delete_leftmost_leaf_updates_cache}, {"test_fbtree_delete_rightmost_leaf_updates_cache", test_fbtree_delete_rightmost_leaf_updates_cache}, {"test_fbtree_rank_single_leaf", test_fbtree_rank_single_leaf}, {"test_fbtree_rank_multilevel", test_fbtree_rank_multilevel}, {"test_fbtree_rank_after_delete", test_fbtree_rank_after_delete}, {"test_fbtree_get_rank_of_item", test_fbtree_get_rank_of_item}, {"test_fbtree_seek_to_rank", test_fbtree_seek_to_rank}, {"test_fbtree_rank_deep_tree", test_fbtree_rank_deep_tree}, {"test_fbtree_seek_to_score_exact", test_fbtree_seek_to_score_exact}, {"test_fbtree_seek_to_score_between", test_fbtree_seek_to_score_between}, {"test_fbtree_seek_to_score_past_end", test_fbtree_seek_to_score_past_end}, {"test_fbtree_seek_to_score_past_end_then_prev", test_fbtree_seek_to_score_past_end_then_prev}, {"test_fbtree_seek_to_score_before_start_then_next", test_fbtree_seek_to_score_before_start_then_next}, {"test_fbtree_seek_to_score_before_start", test_fbtree_seek_to_score_before_start}, {"test_fbtree_seek_to_score_empty", test_fbtree_seek_to_score_empty}, {"test_fbtree_seek_to_score_deep_tree", test_fbtree_seek_to_score_deep_tree}, {"test_fbtree_seek_to_score_iterate", test_fbtree_seek_to_score_iterate}, {NULL, NULL}};
...
unitTest __test_ordered_index_c[] = {{"test_ordered_index_skiplist_create_free", test_ordered_index_skiplist_create_free}, {"test_ordered_index_skiplist_insert_single", test_ordered_index_skiplist_insert_single}, {"test_ordered_index_skiplist_insert_multiple_ordered", test_ordered_index_skiplist_insert_multiple_ordered}, {"test_ordered_index_skiplist_duplicate_scores", test_ordered_index_skiplist_duplicate_scores}, {"test_ordered_index_skiplist_rank_operations", test_ordered_index_skiplist_rank_operations}, {"test_ordered_index_skiplist_delete", test_ordered_index_skiplist_delete}, {"test_ordered_index_skiplist_update_score", test_ordered_index_skiplist_update_score}, {"test_ordered_index_skiplist_delete_range_by_score", test_ordered_index_skiplist_delete_range_by_score}, {"test_ordered_index_skiplist_delete_range_by_rank", test_ordered_index_skiplist_delete_range_by_rank}, {"test_ordered_index_skiplist_edge_cases", test_ordered_index_skiplist_edge_cases}, {"test_ordered_index_skiplist_delete_edge_cases", test_ordered_index_skiplist_delete_edge_cases}, {"test_ordered_index_skiplist_rank_edge_cases", test_ordered_index_skiplist_rank_edge_cases}, {"test_ordered_index_skiplist_duplicate_insert", test_ordered_index_skiplist_duplicate_insert}, {"test_ordered_index_skiplist_update_score_edge_cases", test_ordered_index_skiplist_update_score_edge_cases}, {"test_ordered_index_skiplist_range_delete_edge_cases", test_ordered_index_skiplist_range_delete_edge_cases}, {"test_ordered_index_skiplist_traversal_edge_cases", test_ordered_index_skiplist_traversal_edge_cases}, {"test_ordered_index_skiplist_mixed_operations_rank_integrity", test_ordered_index_skiplist_mixed_operations_rank_integrity}, {"test_ordered_index_skiplist_backward_traversal_after_deletions", test_ordered_index_skiplist_backward_traversal_after_deletions}, {"test_ordered_index_skiplist_lexicographic_edge_cases", test_ordered_index_skiplist_lexicographic_edge_cases}, {"test_ordered_index_skiplist_range_boundary_precision", test_ordered_index_skiplist_range_boundary_precision}, {"test_ordered_index_skiplist_special_double_values", test_ordered_index_skiplist_special_double_values}, {"test_ordered_index_skiplist_seek_to_rank", test_ordered_index_skiplist_seek_to_rank}, {"test_ordered_index_skiplist_reverse_iteration", test_ordered_index_skiplist_reverse_iteration}, {"test_ordered_index_skiplist_seek_to_score_range", test_ordered_index_skiplist_seek_to_score_range}, {"test_ordered_index_skiplist_seek_to_score_range_iteration", test_ordered_index_skiplist_seek_to_score_range_iteration}, {"test_ordered_index_skiplist_seek_inf_reverse_iteration", test_ordered_index_skiplist_seek_inf_reverse_iteration}, {"test_ordered_index_skiplist_seek_inf_forward_iteration", test_ordered_index_skiplist_seek_inf_forward_iteration}, {"test_ordered_index_fbtree_create_free", test_ordered_index_fbtree_create_free}, {"test_ordered_index_fbtree_insert_single", test_ordered_index_fbtree_insert_single}, {"test_ordered_index_fbtree_insert_multiple_ordered", test_ordered_index_fbtree_insert_multiple_ordered}, {"test_ordered_index_fbtree_duplicate_scores", test_ordered_index_fbtree_duplicate_scores}, {"test_ordered_index_fbtree_rank_operations", test_ordered_index_fbtree_rank_operations}, {"test_ordered_index_fbtree_delete", test_ordered_index_fbtree_delete}, {"test_ordered_index_fbtree_update_score", test_ordered_index_fbtree_update_score}, {"test_ordered_index_fbtree_edge_cases", test_ordered_index_fbtree_edge_cases}, {"test_ordered_index_fbtree_delete_edge_cases", test_ordered_index_fbtree_delete_edge_cases}, {"test_ordered_index_fbtree_rank_edge_cases", test_ordered_index_fbtree_rank_edge_cases}, {"test_ordered_index_fbtree_duplicate_insert", test_ordered_index_fbtree_duplicate_insert}, {"test_ordered_index_fbtree_update_score_edge_cases", test_ordered_index_fbtree_update_score_edge_cases}, {"test_ordered_index_fbtree_traversal_edge_cases", test_ordered_index_fbtree_traversal_edge_cases}, {"test_ordered_index_fbtree_mixed_operations_rank_integrity", test_ordered_index_fbtree_mixed_operations_rank_integrity}, {"test_ordered_index_fbtree_backward_traversal_after_deletions", test_ordered_index_fbtree_backward_traversal_after_deletions}, {"test_ordered_index_fbtree_lexicographic_edge_cases", test_ordered_index_fbtree_lexicographic_edge_cases}, {"test_ordered_index_fbtree_special_double_values", test_ordered_index_fbtree_special_double_values}, {"test_ordered_index_fbtree_seek_to_rank", test_ordered_index_fbtree_seek_to_rank}, {"test_ordered_index_fbtree_reverse_iteration", test_ordered_index_fbtree_reverse_iteration}, {NULL, NULL}};
...
unitTest __test_zset_fbtree_adapter_c[] = {{"test_score_roundtrip_positive", test_score_roundtrip_positive}, {"test_score_roundtrip_negative", test_score_roundtrip_negative}, {"test_score_ordering_special", test_score_ordering_special}, {"test_score_ordering_signed_zero", test_score_ordering_signed_zero}, {"test_score_ordering_positive", test_score_ordering_positive}, {"test_score_ordering_negative", test_score_ordering_negative}, {"test_score_ordering_mixed", test_score_ordering_mixed}, {"test_score_ordering_subnormal", test_score_ordering_subnormal}, {"test_pack_unpack_basic", test_pack_unpack_basic}, {"test_pack_unpack_empty_element", test_pack_unpack_empty_element}, {"test_pack_unpack_binary_element", test_pack_unpack_binary_element}, {"test_pack_unpack_negative_score", test_pack_unpack_negative_score}, {"test_pack_unpack_infinity", test_pack_unpack_infinity}, {"test_packed_lexicographic_order", test_packed_lexicographic_order}, {"test_packed_same_score_element_order", test_packed_same_score_element_order}, {NULL, NULL}};
...
struct unitTestSuite {
    ...
    {"test_fbtree_feature_search.c", __test_fbtree_feature_search_c},
    {"test_fbtree_ordered_index.c", __test_fbtree_ordered_index_c},
    ...
    {"test_ordered_index.c", __test_ordered_index_c},
    ...
    {"test_zset_fbtree_adapter.c", __test_zset_fbtree_adapter_c},
};
